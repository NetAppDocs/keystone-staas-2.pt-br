...
Entre em contato com o suporte do NetApp Keystone para obter mais informações sobre essas mensagens. Para obter informações sobre como abrir solicitações de serviço, consulte link:../concepts/support-services.html#generating-service-requests["Gerando solicitações de serviço"].
