...
* Embora o Console e Digital Advisor ofereçam alguns recursos exclusivos, o Console fornece funcionalidades administrativas para Keystone, permitindo que você gerencie assinaturas e faça os ajustes necessários. Para saber mais, consulte link:https://docs.netapp.com/us-en/console-setup-admin/reference-iam-keystone-roles.html["Funções de acesso Keystone no NetApp Console"^].
