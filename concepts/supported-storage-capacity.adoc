...
Essa é a quantidade de capacidade de storage necessária para armazenar dados de usuário antes que quaisquer eficiências de dados fornecidas pelo array de storage sejam aplicadas.
