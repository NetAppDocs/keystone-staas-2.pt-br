...
summary: A API REST do Digital Advisor recupera os detalhes de consumo atuais para todas as assinaturas associadas ao customerID fornecido. 
---
...
| *Ponto final* | `https://api.activeiq.netapp.com/v1/keystone/customer/consumption-details` 
...
| *Ponto final* | `https://api.activeiq.netapp.com/v1/keystone/customer/historical-consumption-details` 
