...
[role="lead"]
Esta API recupera uma lista de todas as assinaturas e níveis de serviço associados ao customerID fornecido.
...
A API responderá com um objeto JSON contendo uma lista de todas as assinaturas e detalhes de nível de serviço associados para o cliente em questão.  Aqui está um exemplo de resposta:
